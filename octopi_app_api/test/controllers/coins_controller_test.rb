...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { name: @coin.name, price: @coin.price, quantity: @coin.quantity } }, as: :json
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { name: @coin.name, price: @coin.price, quantity: @coin.quantity } }, as: :json
    assert_response 200
  end
